...
export type eNetwork = eEthereumNetwork | ePolygonNetwork | eXDaiNetwork | eCeloNetwork | eCndlNetwork;
...
export enum eContractid {
  ...
  LendingPoolCollateralManagerWithReserve = 'LendingPoolCollateralManagerWithReserve',
  ...
  LendingPoolCollateralManagerWithReserveImpl = 'LendingPoolCollateralManagerWithReserveImpl',
...
export type iMaticPoolAssets<T> = Pick<
  iAssetsWithoutUSD<T>,
  'DAI' | 'USDC' | 'USDT' | 'WBTC' | 'WETH' | 'WMATIC' | 'CNDL'
>;

export type iXDAIPoolAssets<T> = Pick<
  iAssetsWithoutUSD<T>,
  'DAI' | 'USDC' | 'USDT' | 'WBTC' | 'WETH' | 'STAKE' | 'CNDL'
>;

export type iMoolaPoolAssets<T> = Pick<
  iAssetsWithoutUSD<T>,
  'CELO' | 'CUSD' | 'CEUR' | 'CREAL' | 'MOO' | 'CNDL'
>;
