...
// Refactor code to include cOIL, CNDL, WCNDL, cEUR, cUSD, WETH, DAI, ETH. 
...
const { COINBASEWALLET } = require('web3modal/dist/providers/providers');
const { coinbasewallet } = require('web3modal/dist/providers/connectors');
...
// double check address for CNDL = Add deployed CNDL address for this contract / 
cCNDL = new kit.web3.eth.Contract(MToken, '');
